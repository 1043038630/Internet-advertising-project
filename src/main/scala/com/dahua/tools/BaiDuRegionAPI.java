 ...
 * 调用百度的地理编码API
 */
public class BaiDuRegionAPI {

    private static final Log log = LogFactory.get();

    public static void main(String[] args) throws Exception {
        BaiDuRegionAPI snTools = new BaiDuRegionAPI();
    ...
    public static String getBusiness(String latAndLong) throws Exception,
        ...
        BaiDuRegionAPI snCal = new BaiDuRegionAPI();
...
// 请求参数。
        ...
        paramsMap.put("ak", "ra85RwbbmpifFbScpgvzOGc5PI0wUn3r");
        String business = "";
        ...
        System.out.println("编码后" + paramsStr);


        // 对paramsStr前面拼接上/geocoder/v2/?，后面直接拼接yoursk得到/geocoder/v2/?address=%E7%99%BE%E5%BA%A6%E5%A4%A7%E5%8E%A6&output=json&ak=yourakyoursk
        //String wholeStr = new String("/reverse_geocoding/v3/?" + paramsStr + "brChH6ym4vVZKgIyHl6cFGUN8xIBpjwa");
        String wholeStr = new String("/reverse_geocoding/v3/?" + paramsStr + "k6SskkgTPMKZxwTdAP1qcGjxf3mmpbf2");

        // 对上面wholeStr再作utf8编码
        String tempStr = URLEncoder.encode(wholeStr, "UTF-8");

        // 调用下面的MD5方法得到最后的sn签名7de5a22212ffaa9e326444c75a58f9a0
        System.out.println("sn码：" + snCal.MD5(tempStr));
        ...
        System.out.println("请求地址" + "http://api.map.baidu.com/reverse_geocoding/v3/?" + paramsStr + "&sn=" + sn);
